# BareSoil-VLM / EarthDial

> **BareSoil extension:** See [`baresoil/README.md`](baresoil/README.md) for BareSoilDial, BareSoil-Instruct, BareSoil-Bench, and BareSoil-Agent.
...
See [`baresoil/README.md`](baresoil/README.md) for the bare/barren land VLM pipeline (BareSoil-Instruct, BareSoil-Bench, BareSoil-Agent).
